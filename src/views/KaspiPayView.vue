  ...
  <div class="max-w-lg mx-auto">
    <div class="h-screen bg-[#efefef]">
      ...
      <div v-if="state" class="h-full relative">
        ...
        <div class="bg-[#b9dd7b] h-[19%] sm:h-[18%] pt-8 px-3">
      ...
      <div v-else class="h-full">
        <div class="h-[6%] bg-white mb-4 flex justify-center items-center">
          <span class="font-semibold sm:text-lg text-black"> FTV.KZ </span>
        </div>
        <div class="h-[9%] bg-white mb-10 px-3 pt-5 border-x border-[1px] border-[#d4d4d4]">
        ...
        <div
          class="h-[9%] bg-white mb-10 px-3 flex justify-between items-center border-x border-[1px] border-[#d4d4d4]"
        >
        ...
        <div
          class="h-[9%] bg-white mb-6 px-3 flex justify-between items-center border-x border-[1px] border-[#d4d4d4]"
        >
